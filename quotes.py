...
quote_help = \
	("Need some help comrade? Haha alright, just for you...\n\n"
	"Morning = 'gm'\n"
	"Evening = 'ge'\n"
	"Night = 'gn'\n"
	"Chat = 'ch'\n"
...
quote_insult = [
	...
	"I'll give you as much mora as you want, so how about we get to sparring? I'm dying of boredom!",
]
...
quote_evening = [
	...
	"Evening, comrade! Eaten dinner yet? It won't do to starve yourself. Why don't we get some dinner together? My treat!"
]

quote_night = [
	"Today was great. See you tomorrow, comrade!",
	"This late already? I didn't even notice the time. Good night!",
	"I hope you aren't planning on staying up too late. I need you in top form tomorrow for when we spar!"
]
...
quote_8ball = [
	"I'll give you this bag of mora, so just do what you need to, comrade.",
	"Oh, you're asking me comrade? Sure, I don't see why not.",
	"Without a doubt.",
	"Is this a trick question? Of course!",
	"Hmm... As far as I can tell, yes.",
	"Most likely. ...You seen unconvinced... I'm a bit hurt by this skepticism...",
	"I think the chances are pretty good - you should have more faith in yourself comrade.",
	"You seem like you want me to say yes, so let's go with that.",
	"This seems like the part where I should be saying no, which means the answer is definitely yes.",
	"Why are you asking me this...? Well, either way I think the outlook is good.",

	"...how about you ask Zhongli instead?",
	"A-ahaha... How about I tell you later..."
	"Oh my! Look at the time, I have to go... write to Teucer! See you, comrade!",
	"... (Pretending not to hear)",
	"I'm a bit busy, how about you ask me a bit later? ...I'm definitely not running away!",
	"<:childe_sus_smile:828859134500667412>",
	"<:childe_oh_no:829471579372388362>",

	"...I hope this is just a joke. Of course not!",
	"Don't hold your breath.",
	"Hahah, no.",
	"I think it'd be best not to hope for much.",
	"I don't think so, comrade. Even you must realize it's doubtful."
]